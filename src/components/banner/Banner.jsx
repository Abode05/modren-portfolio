...
{/*     
        ...
        <div className="flex justify-around  items-center flex-col md:flex-row  w-full z-10 ">
          <div className="max-w-md flex flex-col gap-4 z-20">
            <h1 className="text-4xl">try me oit risk free!</h1>
            <p className="text-sm">
          ...
          <button className="px-6 py-2 rounded bg-teal-800">contact</button>
        </div>
      </div>
    </div>
  )
